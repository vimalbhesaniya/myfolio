			...
			<div className='homemain'>
				...
				<div className='hellopicture'>
					<div className='picture'>
						...
						<span className='headline'>As web developer</span>
					</div>
				...
				<div className='followme'>
					<h2 className='h23'>FIND ME ON <span className='findme'>Social Media</span></h2>
					<div className='cardmain'>
						<div className="card">
							<a className="socialContainer containerOne" href="https://www.instagram.com/__veer_007/">
							...
							<a className="socialContainer containerFour" href="https://wa.link/ming63">
				...
				<h4 className='h24'>© 2023NextJS & CSS Portfolio By Vimal Bhesaniya</h4>
				</div>
			</div>
